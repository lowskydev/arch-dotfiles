...
require("lazy").setup({
  ...
  -- Bridges mason and lspconfig (v2)
  {
    ...
    config = function()
      require("mason-lspconfig").setup({
        ...
        -- automatic_installation removed in v2
        -- mason-lspconfig now calls vim.lsp.enable() automatically
      })
  ...
  -- ==========================================================================
  {
    ...
    opts = {
      default = {
        dir_path = "pictures-md",        -- folder name relative to the md file
        relative_to_current_file = true, -- always relative to the file, not cwd
        prompt_for_file_name = true,     -- asks you for a name before saving
      },
    },
    keys = {
...
opt.timeoutlen = 800 -- faster key sequence timeout
...
-- Markdown/text code block snippets
